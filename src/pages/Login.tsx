      ...
      <Modal open={picker} onClose={() => { setPicker(false); setLinkSent(false); }} size="sm" title={linkSent ? 'Check your email' : 'Try Musa OS for a day'}
        ...
        {configured && (
          <label className="mt-4 block">
            ...
            <input type="email" autoComplete="email" value={demoEmail} onChange={(e) => setDemoEmail(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && launch()} className="input" placeholder="you@school.co.zw" />
          </label>
        )}
